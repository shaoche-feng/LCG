...
# scripts/ was reorganized into topic subfolders after this file was first written; these
# extra entries let this module (and anything that imports it) still find its sibling
# dependency regardless of exactly where this file itself ends up nested.
sys.path.insert(0, str(_REPO_ROOT / "scripts" / "precision_h_D_diagnostic"))
